namespace Hunting
{
    public class Animal
    {
        ...
        public Animal(int weight, Gender gender) { this.weight = weight; this.gender = gender; }
    ...
    class Elephant : Animal
    {
        ...
        public Elephant(int weight, int ltusk, int rtusk, Gender gender) : base(weight, gender) 
    ...
    {
        public int Horn { get; }
        public Rhino(int weight, int horn, Gender gender) : base(weight, gender) 
        { Horn = horn; }
        public override bool IsRhino() { return true; }
    }
    class Lion : Animal 
    {
        public Lion(int weight, Gender gender) : base(weight, gender) 
        {  }
